    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (var md5Hash = MD5.Create())
            {
                ...
                Console.WriteLine( hashBytes.GetHashCode() );
            }
        ...
        public static string ReadReestrInfo() //Write value
        {
            ...
            RegistryKey myKey = currentUserKey.OpenSubKey("Androshchuk", true);

            string data = myKey.GetValue("AndroshchukYurii").ToString();
            myKey.Close();
            return data;
        ...
        public static async Task SavetoJson()
        {
            ...
            {
                fs.SetLength(0);
                User u = new User { ID = 1, Login = "qwe", Password = "qwe", Type ="Admin" };
    ...
    public class System 
    {
        public static void Menu()
        {
            ...
            switch (selection)
            {
                ...
                case "3":
                    ...
                    break;
                default:
                    Console.WriteLine("Am I a joke to you?");
                    Console.ReadKey();
                    Console.Clear();
                    Environment.Exit(-1);
                    break;
        ...
        public static async Task ChangePasswordUser(User user)
        {
            ...
            while (flag)
            {
                ...
                {
                    Console.WriteLine("Its OK");
                    int n = Regex.Matches(newpass, @"[a-zA-Z]|[+,-]|['%','/','*']").Count; int l = newpass.Length;
                    if (user.PasswordRequirement == 1) // check for pass reuire
                    {
                        ...
                        else { Console.WriteLine("You have used smth bad use only a-Z letters and +-%/*"); Console.ReadKey(); }
                    }
